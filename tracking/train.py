...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str,  default='rdtt', help='training script name')
    ...
    parser.add_argument('--config_prv', type=str, default='rdtt', help='yaml configure file name')
